...
namespace KeyboardLibrary
{
    ...
    public abstract class GlobalHook
    {
       ...
       [ StructLayout(LayoutKind.Sequential)]
        ...
        protected const byte VK_LWIN = 0x5B;     //Left Windows key on a Microsoft Natural Keyboard
        protected const byte VK_RWIN = 0x5C;    //Right Windows key on a Microsoft Natural Keyboard
        protected const byte VK_LMENU = 0xA4;   //Left MENU key
        protected const byte VK_RMENU = 0xA5;   //Right MENU key
